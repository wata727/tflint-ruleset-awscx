...
|awscx_ecs_service_daemon_fargate_launch_type|Disallow `scheduling_strategy = "DAEMON"` when `aws_ecs_service.launch_type = "FARGATE"`|ERROR|✔|https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ecs_service|
|awscx_ecs_service_daemon_unsupported_deployment_controller|Disallow `scheduling_strategy = "DAEMON"` when `aws_ecs_service.deployment_controller.type` is `CODE_DEPLOY` or `EXTERNAL`|ERROR|✔|https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ecs_service|
...
|awscx_lambda_function_zip_required_attributes|Require `handler` and `runtime` when `aws_lambda_function.package_type` is `Zip` or omitted|ERROR|✔|https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lambda_function|
...
|awscx_sqs_queue_policy_missing_current_version|Require `aws_sqs_queue_policy.policy` to set top-level `Version = "2012-10-17"`|ERROR|✔|https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/sqs_queue|
